...
class VxColor {
  ...
  static const Color cC8DDFC = Color(0xFFC8DDFC);
  static const Color c00C8DDFC = Color(0x00C8DDFC);
  ...
  // ignore: constant_identifier_names
  static const LinearGradient cC8DDFC100_cC8DDFC0 = LinearGradient(
    colors: [cC8DDFC, c00C8DDFC],
    begin: Alignment.topRight,
    end: Alignment.bottomCenter,
  );
  // ignore: constant_identifier_names
  static const LinearGradient cC8DDFC100_cC8DDFC0_center = LinearGradient(
    colors: [cC8DDFC, c00C8DDFC],
    begin: Alignment.topRight,
    end: Alignment.bottomRight,
  );
  // ignore: constant_identifier_names
  static const LinearGradient cE8F5FF_cffffff = LinearGradient(
    colors: [cE8F5FF, cFFFFFF],
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
  );
